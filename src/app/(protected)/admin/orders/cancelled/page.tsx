// src/app/(protected)/admin/orders/cancelled/page.tsx
...
export default async function CancelledOrdersPage() {
  ...
  // Fetch all cancelled orders with customer & order items
    ...
    <div className="py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link 
            ...
            className="px-4 py-2 bg-red-100 text-red-800 rounded-md font-medium"
          >
      ...
      {ordersWithProductDetails.length === 0 ? (
        <div className="text-center py-16 bg-gray-50 rounded-lg border border-dashed border-gray-300">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">No Cancelled Orders</h2>
          <p className="text-gray-600 max-w-md mx-auto">
            There are no cancelled orders. When you cancel a pending order, it will appear here.
          </p>
          <div className="mt-6">
            <Link 
              href="/admin/orders"
